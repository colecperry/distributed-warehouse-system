...
- **CPU**: ~30-40% during normal operation
- **Memory**: ~4-6 GB total for all 10 containers
- **Disk**: ~2-3 GB for images

### If Running Slow:
1. Close other applications
2. Increase Docker Desktop memory limit (Preferences → Resources)
3. Run fewer services (e.g., skip database followers for simple tests)
...
And running `./test-services.sh` should show:
```
Passed: 14
Failed: 0
All tests passed! ✓
